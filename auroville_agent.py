...
4. You may fix duplicate or repeated plain-text sentences *outside* the list.
5. Remove duplicate events.
5. You may correct small grammar issues *outside* the numbered blocks.
6. When tool output lists categories, keep them exactly:
